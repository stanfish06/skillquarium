...
compatibility: Requires Python >=3.11 and fluidsim 0.9.0+. FFT support (required for most solvers) needs the [fft] extra; MPI parallelization needs the [mpi] extra.
