...
# Root-level run summaries (generated by reporting.py, not pipeline outputs):
# excluded from the manifest, matching the sibling wrappers.
_CHECKSUM_EXCLUDE_ROOT_FILES: frozenset[str] = frozenset({"report.md", "result.json"})
