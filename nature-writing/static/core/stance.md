...
Draft and revise so the paper answers the five reader questions in order: relevance, novelty, trust, reuse, meaning.
...
- **terminology**: on first contact with the material, extract the recurring methods, models, datasets, metrics, abbreviations, and notation into a Terminology Ledger and reuse the canonical forms across every section
