...
- [timesfm-forecasting](../timesfm-forecasting.md) — Zero-shot time series forecasting with Google's TimesFM foundation model
...
- [umap-learn](../umap-learn.md) — Use UMAP-learn for nonlinear dimensionality reduction, 2D/3D embeddings, clustering preprocessing, supervised or semi-supervised UMAP, DensMAP, AlignedUMAP, and Parametric UMAP...
