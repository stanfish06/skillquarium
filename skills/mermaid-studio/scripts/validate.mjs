...
// deps live outside the vault so npm installs never land in the skill folder
const DEPS_DIR =
  process.env.MERMAID_STUDIO_DIR ||
  resolve(process.env.XDG_CACHE_HOME || resolve(process.env.HOME, ".cache"), "mermaid-studio");
