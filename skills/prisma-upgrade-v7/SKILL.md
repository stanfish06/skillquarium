...
- **Latest stable Prisma ORM version**: `7.10.0` (Prisma 8 is in release-candidate; check for a v8 guide before assuming this is still current)
...
MongoDB does not have a SQL `@prisma/adapter-*` package in the published Prisma 7.x packages. If you're upgrading a MongoDB project, stop and keep that project on the latest Prisma 6.x release instead of following the standard Prisma 7 migration path.
