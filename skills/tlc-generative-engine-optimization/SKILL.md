...
- Classic metadata fixes alone (title, description, canonical, Open Graph) → use `fixing-metadata`
- Accessibility audits → use `fixing-accessibility`
- Page performance and Core Web Vitals → use `web-perf`
